---
name: sdd-from-figma
description: Seed a new feature from a Figma page/component URL. Extracts design context via Figma MCP, infers feature name and initial requirements, scaffolds .specs/<feature>/ folder with manifest.yaml and requirements.md draft. Use as the entry point when starting work from a Figma design. Trigger phrases - "/sdd-from-figma <url>", "start from this figma", "implement this figma design".
---
