---
name: sdd-from-text
description: Seed a new feature from a text description (bug report, feature request, slack thread, issue body). Infers feature name and initial requirements, scaffolds .specs/<feature>/ with manifest and requirements draft. Use as the entry point when no Figma design exists. Trigger phrases - "/sdd-from-text", "start from this description", "from this bug report".
---
