---
name: sdd-branch
description: Create a worktree (or branch) for the active feature, enforcing naming convention <type>/<issue#>-<slug>. Pulls base branch, runs .specs/bootstrap.sh if present, and updates manifest. Trigger phrases - "/sdd-branch", "create worktree", "start branch".
---
